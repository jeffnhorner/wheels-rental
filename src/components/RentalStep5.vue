<template>
  <div v-bind:class="$style.container">
    ...
    <div v-bind:class="$style.topWrapper">
      ...
      >
        <g-image v-bind:class="$style.image" src="~/assets/privateRental.png" />
        <p>Private Rental</p>
        <input
...
export default {
  ...
  created() {
    ...
    if (this.$store.state.userData?.bikeRentalType) {
      ...
      this.isActivePrivatePlan = Boolean(
        this.$store.state.userData.bikeRentalType === "private"
      );
      this.isActiveDeliveryPlan = Boolean(
        this.$store.state.userData.bikeRentalType === "delivery"
      );
    }
  },
